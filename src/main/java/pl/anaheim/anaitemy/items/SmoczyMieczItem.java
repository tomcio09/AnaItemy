...
public class SmoczyMieczItem {

    public static final String ITEM_NAME_STRIPPED = "Smoczy miecz";
    public static final int CUSTOM_MODEL_DATA = 1;
    private static final NamespacedKey SMOCZY_KEY = new NamespacedKey(AnaItemy.getInstance(), "smoczy_miecz");

    public static ItemStack create() {
        List<String> lore = Arrays.asList(
                "&7Posiada on możliwość strzelania",
                "&dperłami kresu&7!"
        );
    ...
    public static boolean isSmoczyMiecz(ItemStack item) {
        ...
        Byte marker = item.getItemMeta().getPersistentDataContainer()
                .get(SMOCZY_KEY, PersistentDataType.BYTE);
