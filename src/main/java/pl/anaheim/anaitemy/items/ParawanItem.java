...
public class ParawanItem {
    public static final String ITEM_NAME_STRIPPED = "Parawan";
    public static final int CUSTOM_MODEL_DATA = 1;

    public static ItemStack create() {
        ItemStack item = new ItemStack(Material.FEATHER);
        ItemMeta meta = item.getItemMeta();
        meta.displayName(LegacyComponentSerializer.legacyAmpersand().deserialize("&e&lParawan").decoration(TextDecoration.ITALIC, false));
        List<Component> lore = new ArrayList<>();
        for (String line : Arrays.asList(" &8» &7Jest to przedmiot zdobyty z", " &8» &fwydarzenia wakacyjnego 2024&7!", "", " &8» &7Po użyciu tego przedmiotu odrzuca", " &8» &7wszystkich przeciwników w okolicy!"))
    ...
    public static boolean isParawan(ItemStack item) {
