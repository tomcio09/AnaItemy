...
public class KosaItem {

    public static final String ITEM_NAME_STRIPPED = "Kosa";
    public static final int CUSTOM_MODEL_DATA = 1;
    private static final NamespacedKey KOSA_KEY = new NamespacedKey(AnaItemy.getInstance(), "kosa_item");
    ...
    public static ItemStack create() {
        List<String> lore = Arrays.asList(
                ...
                "",
                " &8» &7Twoje uderzenie może &fco minutę",
                " &8» &7przestraszyć przeciwnika nadając",
                " &8» &7mu efekty utrudniające widoczność"
        );
        ...
        meta.getPersistentDataContainer().set(KOSA_KEY, PersistentDataType.BYTE, (byte) 1);

        item.setItemMeta(meta);
        return item;
    }

    public static boolean isKosa(ItemStack item) {
        ...
        Byte marker = item.getItemMeta().getPersistentDataContainer()
                .get(KOSA_KEY, PersistentDataType.BYTE);
