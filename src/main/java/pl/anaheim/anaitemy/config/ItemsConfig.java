...
public class ItemsConfig {
    ...
    // ==================== EXCALIBUR ====================
    public String getExcaliburName() { return config.getString("excalibur.name", "&e&lExcalibur"); }
    public int getExcaliburCustomModelData() { return config.getInt("excalibur.custom-model-data", 5); }
    public int getExcaliburGuiSlot() { return config.getInt("excalibur.gui-slot", 1); }
    public int getExcaliburSharpness() { return config.getInt("excalibur.enchants.sharpness", 6); }
    public int getExcaliburFireAspect() { return config.getInt("excalibur.enchants.fire-aspect", 2); }
    public int getExcaliburUnbreaking() { return config.getInt("excalibur.enchants.unbreaking", 3); }
    public double getExcaliburAttackSpeed() { return config.getDouble("excalibur.attack-speed", -2.0); }
    public double getExcaliburBaseDamage() { return config.getDouble("excalibur.base-damage", 11.5); }
    ...
    public List<String> getHydroKlatkaLore() { return config.getStringList("hydro-klatka.lore"); }
    public int getHydroKlatkaCustomModelData() { return config.getInt("hydro-klatka.custom-model-data", 2); }
    public int getHydroKlatkaGuiSlot() { return config.getInt("hydro-klatka.gui-slot", 2); }
    public long getHydroKlatkaCooldown() { return config.getLong("hydro-klatka.cooldown", 180); }
    public int getHydroKlatkaRadius() { return config.getInt("hydro-klatka.cage.radius", 7); }
    public int getHydroKlatkaDuration() { return config.getInt("hydro-klatka.cage.duration", 15); }
    public int getHydroKlatkaAnimationDuration() { return config.getInt("hydro-klatka.cage.animation-duration", 60); }
    public String getHydroKlatkaShootSound() { return config.getString("hydro-klatka.sounds.shoot.sound", "ITEM_CROSSBOW_SHOOT"); }
    public float getHydroKlatkaShootVolume() { return (float) config.getDouble("hydro-klatka.sounds.shoot.volume", 2.0); }
    public float getHydroKlatkaShootPitch() { return (float) config.getDouble("hydro-klatka.sounds.shoot.pitch", 1.0); }
    public String getHydroKlatkaCustomSound() { return config.getString("hydro-klatka.sounds.cage-create.custom-sound", "custom.hydroklatka"); }
    public float getHydroKlatkaCustomSoundVolume() { return (float) config.getDouble("hydro-klatka.sounds.cage-create.volume", 3.0); }
    public float getHydroKlatkaCustomSoundPitch() { return (float) config.getDouble("hydro-klatka.sounds.cage-create.pitch", 1.0); }
    public String getHydroKlatkaExplodeSound() { return config.getString("hydro-klatka.sounds.cage-explode.sound", "ENTITY_GENERIC_EXPLODE"); }
    public float getHydroKlatkaExplodeVolume() { return (float) config.getDouble("hydro-klatka.sounds.cage-explode.volume", 1.5); }
    public float getHydroKlatkaExplodePitch() { return (float) config.getDouble("hydro-klatka.sounds.cage-explode.pitch", 1.0); }
    public String getHydroKlatkaRemoveSound() { return config.getString("hydro-klatka.sounds.cage-remove.sound", "ENTITY_GENERIC_SPLASH"); }
    public float getHydroKlatkaRemoveVolume() { return (float) config.getDouble("hydro-klatka.sounds.cage-remove.volume", 1.5); }
    public float getHydroKlatkaRemovePitch() { return (float) config.getDouble("hydro-klatka.sounds.cage-remove.pitch", 1.2); }
    public String getHydroKlatkaChunkBlockedSound() { return config.getString("hydro-klatka.sounds.chunk-blocked.sound", "BLOCK_GLASS_BREAK"); }
    public float getHydroKlatkaChunkBlockedVolume() { return (float) config.getDouble("hydro-klatka.sounds.chunk-blocked.volume", 1.0); }
    public float getHydroKlatkaChunkBlockedPitch() { return (float) config.getDouble("hydro-klatka.sounds.chunk-blocked.pitch", 0.5); }
    ...
    public String getHydroKlatkaAmbientSound() { return config.getString("hydro-klatka.sounds.ambient.sound", "BLOCK_WATER_AMBIENT"); }
    ...
    public int getRozdzkailuzjonistyUnbreaking() { return config.getInt("rozdzka-iluzjonisty.enchants.unbreaking", 10); }
    public long getRozdzkailuzjonistyFangsCooldown() { return config.getLong("rozdzka-iluzjonisty.fangs.cooldown", 20); }
    public int getRozdzkailuzjonistyFangsLength() { return config.getInt("rozdzka-iluzjonisty.fangs.length", 7); }
    public int getRozdzkailuzjonistyFangsWidth() { return config.getInt("rozdzka-iluzjonisty.fangs.width", 3); }
    ...
    public int getWedkaNielotaUnbreaking() { return config.getInt("wedka-nielota.enchants.unbreaking", 10); }
    public int getWedkaNielotaCurseDuration() { return config.getInt("wedka-nielota.curse-duration", 12); }
    public long getWedkaNielotaCooldown() { return config.getLong("wedka-nielota.cooldown", 30); }
    ...
    // ==================== SAKIEWKA DROPU ====================
    public String getSakiewkaDropuName() { return config.getString("sakiewka-dropu.name", "&a&lSakiewka dropu"); }
    public List<String> getSakiewkaDropuLore() { return config.getStringList("sakiewka-dropu.lore"); }
    public int getSakiewkaDropuCustomModelData() { return config.getInt("sakiewka-dropu.custom-model-data", 1); }
    ...
    public boolean isBlockSakiewkaInCombat() { return config.getBoolean("combat-integration.block-sakiewka-in-combat", true); }
    public boolean isHydroKlatkaTagPlayers() { return config.getBoolean("combat-integration.hydroklatka-tag-players", true); }
    public boolean isActionBarIntegrationEnabled() { return config.getBoolean("combat-integration.actionbar.enabled", true); }
    public int getActionBarResumeDelay() { return config.getInt("combat-integration.actionbar.resume-delay", 40); }

    // ==================== ITEM PROTECTION ====================
    public boolean isItemProtectionEnabled() { return plugin.getConfig().getBoolean("item-protection.enabled", true); }
    ...
    public int getBlokWidmoGuiSlot() { return config.getInt("blok-widmo.gui-slot", 7); }
    public int getBlokWidmoRadius() { return config.getInt("blok-widmo.radius", 20); }
    public int getBlokWidmoEffectDuration() { return config.getInt("blok-widmo.effect-duration", 160); }
    public double getBlokWidmoHealthReduction() { return config.getDouble("blok-widmo.health-reduction", 20); }
    public double getBlokWidmoMinimumHealth() { return config.getDouble("blok-widmo.minimum-health", 20); }
    public long getBlokWidmoCooldown() { return config.getLong("blok-widmo.cooldown", 180); }
    ...
    public long getCudownaLatarniaCooldown() { return config.getLong("cudowna-latarnia.cooldown", 180); }
    public long getCudownaLatarniaChunkCooldown() { return config.getLong("cudowna-latarnia.chunk-cooldown", 60); }
    public int getCudownaLatarniaRegenDuration() { return config.getInt("cudowna-latarnia.effects.regeneration.duration", 20); }
    public int getCudownaLatarniaRegenLevel() { return config.getInt("cudowna-latarnia.effects.regeneration.level", 5); }
    public int getCudownaLatarniaAbsorptionDuration() { return config.getInt("cudowna-latarnia.effects.absorption.duration", 10); }
    public int getCudownaLatarniaAbsorptionLevel() { return config.getInt("cudowna-latarnia.effects.absorption.level", 6); }
    public int getCudownaLatarniaStrengthDuration() { return config.getInt("cudowna-latarnia.effects.strength.duration", 10); }
    public int getCudownaLatarniaStrengthLevel() { return config.getInt("cudowna-latarnia.effects.strength.level", 2); }
    public List<String> getCudownaLatarniaBlockedRegions() { return config.getStringList("cudowna-latarnia.blocked-regions"); }
    public String getCudownaLatarniaActivatedSubtitle() { return config.getString("cudowna-latarnia.messages.activated-subtitle", "&5Cudowna Latarnia! &7Aktywowana na &d30 sekund&7!"); }
    public String getCudownaLatarniaDestroyedSubtitle() { return config.getString("cudowna-latarnia.messages.destroyed-subtitle", "&7Zniszczyłeś &5legendarną fontannę&7!"); }
